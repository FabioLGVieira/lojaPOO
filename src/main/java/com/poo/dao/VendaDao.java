...
public class VendaDao {
	...
	public static List<Venda> buscar(String busca) throws SQLException, Exception {
		String sql = "SELECT p.idProduto, p.nome, p.preco, p.quantidade, v.idVenda, v.data, v.pagamento,v.parcela, v.subTotal,c.idCliente FROM Venda as v "
				+ " join cadastroProduto as p" + " on p.idProduto = v.idProduto" + " join cadastroCliente as c"
				+ " on c.idCliente = v.idCliente" + " join cadastroFuncionario as f" + " on f.id = v.idFuncionario"
